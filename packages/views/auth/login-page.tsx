...
interface LoginPageProps {
  ...
  /** Whether email-code auth is enabled. Defaults to true. */
...
export function LoginPage({
  ...
  // -------------------------------------------------------------------------
  if (!emailCodeEnabled) {
    const hasGoogleLogin = Boolean(google || onGoogleLogin);
    return (
      <div className="flex min-h-svh items-center justify-center">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {hasGoogleLogin ? "" : "Email code sign-in is disabled for this deployment."}
            </CardDescription>
          </CardHeader>
