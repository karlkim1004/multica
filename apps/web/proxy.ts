...
const NEXAI_LEGACY_HOST = "multica.nexai.co.kr";
const NEXAI_MARKETING_URL = "https://nexai.co.kr";
...
export function proxy(req: NextRequest) {
  ...
  if (
    host === NEXAI_LEGACY_HOST &&
    !req.cookies.get(LOGGED_IN_COOKIE)?.value &&
    !isNexaiRedirectExemptPath(pathname) &&
    wantsDocument(req)
  ) {
    return NextResponse.redirect(NEXAI_MARKETING_URL, 307);
  }
