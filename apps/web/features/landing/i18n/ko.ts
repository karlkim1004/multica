      ...
      steps: [
        {
          ...
          description: allowSignup
            ? "Google로 로그인하면 바로 시작할 수 있습니다. 워크스페이스는 자동으로 만들어지며, 별도의 설정 과정도 없습니다."
            : "Google로 로그인하면 바로 워크스페이스에 들어갈 수 있습니다. 별도의 설정 과정도 없습니다.",
        },
        {
      ...
      entries: [
        ...
        },
        {
          ...
          fixes: [
            ...
            "로그인 화면 포커스와 상세 화면 사이드바 동작이 더 안정적으로 유지됩니다.",
