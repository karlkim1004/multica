...
RETURNING id, issue_id, author_type, author_id, content, type, created_at, updated_at, parent_id, workspace_id, resolved_at, resolved_by_type, resolved_by_id, source_task_id, verdict, verified_ref, criteria_version, verifier_agent_id
`
...
type CreateCommentParams struct {
	...
	VerifiedRef     pgtype.Text `json:"verified_ref"`
	CriteriaVersion pgtype.Text `json:"criteria_version"`
...
SELECT id, issue_id, author_type, author_id, content, type, created_at, updated_at, parent_id, workspace_id, resolved_at, resolved_by_type, resolved_by_id, source_task_id, verdict, verified_ref, criteria_version, verifier_agent_id FROM comment
WHERE id = $1
`
...
SELECT c.id, c.issue_id, c.author_type, c.author_id, c.content, c.type, c.created_at, c.updated_at, c.parent_id, c.workspace_id, c.resolved_at, c.resolved_by_type, c.resolved_by_id, c.source_task_id, c.verdict, c.verified_ref, c.criteria_version, c.verifier_agent_id FROM comment c
