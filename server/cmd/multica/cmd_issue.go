...
func init() {
	...
	issueCreateCmd.Flags().Bool("pool-dispatch", false, "Opt an unassigned todo into automatic idle-worker claim")
...
func runIssueCreate(cmd *cobra.Command, _ []string) error {
	...
	if v, _ := cmd.Flags().GetBool("pool-dispatch"); v {
		body["pool_dispatch"] = true
	}
